  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setStats({
          total_analyses: user?.analysis_count || 0,
          authentic_images: 0,
          ai_generated_images: 0,
          monthly_analyses_used: user?.analysis_count || 0,
          monthly_limit: user?.monthly_analysis_limit || 10,
          remaining_analyses: (user?.monthly_analysis_limit || 10) - (user?.analysis_count || 0)
        });
        setRecentAnalyses([]);
      } finally {
        setLoading(false);
                        ...
                        <div className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                          ...
                          {analysis.prediction === 'authentic' ? (
                            ...
                            <>
                              ...
                              {analysis.prediction === 'ai_generated' ? 'AI Generated' : 'Manipulated'}
                            </>
                          )}
                        </div>
