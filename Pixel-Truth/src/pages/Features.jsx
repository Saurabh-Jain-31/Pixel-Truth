...
import { Shield, Zap, Eye, Brain, Search, BarChart3, Lock, Globe, Check, X } from 'lucide-react';
...
const Features = () => {
  ...
  const comparisonData = [
    {
      feature: "AI-generated Image Detection",
      pixelTruth: true,
      competitor1: true,
      competitor2: true,
      competitor3: false
    ...
    {
      feature: "OSINT-based Verification",
      pixelTruth: true,
      competitor1: false,
      competitor2: false,
      competitor3: false
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See how we compare to other image verification tools
            </p>
          </div>
            ...
            <div className="bg-blue-50 border-t border-blue-200 px-6 py-4">
              <div className="flex items-center justify-center text-center">
                ...
                <p className="text-blue-800 font-medium">
                  <strong>Pixel Truth Advantage:</strong> Only platform combining ML + OSINT for comprehensive image verification
                </p>
              </div>
            </div>
          </div>
