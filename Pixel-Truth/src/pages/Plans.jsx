            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  {/* Accuracy & Limits Display */}
                  <div className="mb-8 p-4 bg-gray-50 rounded-lg">
                    <div className="grid grid-cols-2 gap-4 text-center">
                      <div>
                        <div className="text-2xl font-bold text-blue-600">{plan.accuracy}</div>
                        <div className="text-sm text-gray-600">Max Accuracy</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-green-600">{plan.analysisLimit}</div>
